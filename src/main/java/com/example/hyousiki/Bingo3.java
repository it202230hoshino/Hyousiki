...
//ビンゴ３×３のクラス
public class Bingo3 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.bingo3);
        ...
        for (int i = 0; i < globals.lva; i++) {
            ...
            if (globals.status[i] == 1) {
                ...
                ImageButton[] imageButton = {ib1, ib2, ib3, ib4, ib5, ib6, ib7, ib8, ib9};//ボタン用配列
        ...
        uiReturn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                //ダイアログを呼ぶ
                BingoDialogFragment dialog = new BingoDialogFragment();
        ...
        finish.setOnClickListener(
                new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        //ダイアログ
                        BingoDialogFragment3 dialog = new BingoDialogFragment3();
                        dialog.show(getSupportFragmentManager(), "Down");
    ...
    public void dialogImage3() {
        ImageView iv = new ImageView(this);
        iv.setImageResource(R.drawable.triplebingo);
        iv.setAdjustViewBounds(true);
        new AlertDialog.Builder(this)
                .setView(iv)
                .show();
    ...
    public void goIntent() {
        ...
        Intent intent = new Intent(Bingo3.this, ImageJudgeCamera.class);
        stopPlayer();
  ...
  public void doYes() {
      {
          Intent intent = new Intent(Bingo3.this, MainActivity.class);
          stopPlayer();
          startActivity(intent);
    ...
    public  void doYesFinish() {
        //終了画面へインテント※※ダイアログにする
        if (globals.g_nScoreFinal <= 20) {
            Intent intent = new Intent(Bingo3.this, BingoResult3.class);
            stopPlayer();
            startActivity(intent);
        } else if (globals.g_nScoreFinal <= 150) {
            Intent intent = new Intent(Bingo3.this, BingoResult2.class);
            stopPlayer();
            startActivity(intent);
        } else {
            Intent intent = new Intent(Bingo3.this, BingoResult.class);
            stopPlayer();
            startActivity(intent);
        }
